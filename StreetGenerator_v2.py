...
class StreetGenerator_v2:
    def __init__(self, size_x, size_y):
        self.size_rows = size_x
        self.size_columns = size_y
        self.number_of_main_road_elements = round((size_x * size_y)/2.08)
        self.road = []
        # self.startpoint = 0
    ...
    def generate_next_element(self):
        ...
        # other elements
            ...
            print("Element nr", (len(self.road) + 1))
            ...
            while new_position in self.road:
                ...
                if shuffle_counter == 10:
                    print("shuffle counter reached", shuffle_counter)
                    print("Cannot shuffle more............................. Generating new part of the road")

                    choosed_element = self.choose_street_element()
                    print("Picked road element is", choosed_element, self.road[choosed_element],
                          ". We will take it from there...")
                    new_position = self.generate(self.road[choosed_element])
                    print("And position for new element:", new_position)
                    while new_position in self.road:
                        print("Element exists in road, choosing new element")
                        choosed_element = self.choose_street_element()
                        print("Picked road element is", choosed_element, self.road[choosed_element],
                              ". We will take it from there...")
                        new_position = self.generate(self.road[choosed_element])
            ...
            print("Point added:", new_position)
    ...
    def choose_street_element(self):
        return random.randrange(0, len(self.road))

    def generate(self, element):

        pos = [element[0], element[1]]  # last element of road arr
        print("pos", pos)
        ...
        if directions[0] != 2 and directions[1] != 2:
            ...
            which_way = 10  # 0-50 = left or right, 51-100 = up or down
            # only left or right

        elif directions[0] != 2 and directions[1] == 2:
            which_way = 60  # 0-50 = left or right, 51-100 = up or down
            # only up or down

        else:
            which_way = -1  # 0-50 = left or right, 51-100 = up or down
        ...
        # up or down
            ...
            print("Not possible to add new element. Returning same element")

        return pos

    def set_direction(self, element):
